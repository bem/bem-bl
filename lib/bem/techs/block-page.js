        ...
        doc.elems.forEach(function(elem){
            ...
            examples.forEach(function(example){
                example.mods && example.mods.forEach(function(ex){
                    ...
                    text.push(ex.descBemjson);
                    text.push({
                        block: 'b-block-example',
                        src: 'examples/' + ex.name + '.' + 'html',
                        id: ex.name
                    })
                })
            })
    ...
    text.push(
            {
                ...
                content: [
                    {
                        elem: 'p',
                        content: '<a href="https://github.com/bem/bem-bl/tree/gh-pages/sets/common-desktop/' + doc.name + '/examples">examples</a>'
                    }
                ]
            }
    );
