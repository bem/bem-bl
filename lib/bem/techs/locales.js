...
exports.bemCreate = function(prefix, vars, force) {
    ...
    locales.forEach(function(locale) {
        ...
        techs.forEach(function(t) {
            // метод create возвращает promise
            // надо обрабатывать promise
            var cr = context.getTech('', t).create(
                localePrefix,
                { BlockName: name, Prefix: localePrefix, Locale: locale }, force);
            Q.fail(cr, function(err){
    ...
    // тут возвращать промис, который сджойнит промис от методов
    // create всех технологий
    return this;
};
