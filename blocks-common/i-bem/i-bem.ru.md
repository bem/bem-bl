#i-bem (помощник для создания других блоков)
##Описание
...
Хелпер декларации блока принимает 3 параметра:
 ...
 2. Методы и свойства экземляра блока. Методы и свойства, предметной областью которых является конкретный инстанс блока на странице. Это как [функции обработки модификаторов](#mods.callbacks), так и [кастомные методы блока](#methods).
